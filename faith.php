...
<head>
    ...
    <title>Faith - Cyber Mathrock</title>
    <meta name="description" content="Christian faith and beliefs of Cyber Mathrock.">
    <link rel="canonical" href="<?php echo htmlspecialchars($siteUrl); ?>/faith.php">
