...
<head>
    ...
    <title>Live Chat - Cyber Mathrock</title>
    <meta name="description" content="Live chat with Cyber Mathrock.">
    <link rel="canonical" href="<?php echo htmlspecialchars($siteUrl); ?>/chat-page.php">
